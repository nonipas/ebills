...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::get('user/services/{id}', 'ManageUsersController@services')->name('users.services');
        Route::get('user/downlines/{id}', 'ManageUsersController@downlines')->name('users.downlines');
        ...
        Route::get('service/category', 'ServiceController@categoryService')->name('service.category');
        Route::post('service/category/store', 'ServiceController@categoryServiceStore')->name('service.category.store');
        Route::post('service/category/update', 'ServiceController@categoryServiceUpdate')->name('service.category.update');

        Route::get('service/create', 'ServiceController@createServicePage')->name('service.page');
        Route::post('service/create', 'ServiceController@serviceStore')->name('service.store');
        Route::get('service/update/{id}', 'ServiceController@serviceUpdatePage')->name('service.update.page');
        Route::post('service/update', 'ServiceController@serviceUpdate')->name('service.update');
        Route::post('manage/service/status', 'ServiceController@serviceStatus')->name('service.status');

        Route::get('service/pending', 'ServiceController@pendingService')->name('applied.pending.service');
        Route::get('service/details/{id}', 'ServiceController@serviceDetails')->name('applied.details');
        Route::post('service/approve', 'ServiceController@serviceApprove')->name('applied.approve');
        Route::post('service/reject', 'ServiceController@serviceReject')->name('applied.reject');
        Route::get('service/approved', 'ServiceController@serviceApproved')->name('applied.approved');
        Route::get('service/rejected', 'ServiceController@serviceCanceled')->name('applied.rejected');
        Route::get('service/applied/all', 'ServiceController@serviceAll')->name('applied.all');
...
//Start Front Bill Payment\
Route::post('/get-services', 'VendingController@ajaxServicesBiller')->name('get-services');
Route::post('/validate-customer', 'VendingController@ajaxValidateCustomer')->name('validate-customer');
Route::post('/send-purchase-request', 'VendingController@sendPurchaseRequest')->name('send-purchase-request');
...
Route::name('user.')->prefix('user')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware(['checkStatus'])->group(function () {
            ...
            Route::post('/service/apply', 'UserController@serviceApply')->name('service.apply');
            Route::get('/service/confirm/{id}', 'UserController@serviceConfirm')->name('service.confirm');
            Route::post('/service/submit', 'UserController@serviceSubmit')->name('service.submit');

            Route::get('/service/history', 'UserController@serviceHistory')->name('history.service');
            Route::get('/service/history/pending', 'UserController@serviceHistoryPending')->name('history.service.pending');


            Route::get('/transaction/history', 'UserController@trxHistory')->name('trx.history');
            Route::get('/downlines', 'UserController@downlines')->name('downlines');
