    ...
    <div class="account-wrapper">
      ...
      @csrf
        ...
        <div class="form-group">
          <button type="submit" class="cmn-btn py-3 w-100">@lang('VERIFY CODE')</button>
        </div>
        <p class="text-center">@lang('Please check including your Junk/Spam Folder. if not found, you can') <a href="{{ route('user.password.request') }}" class="base--color">@lang('Try to send again')...</a></p>
      </form>
