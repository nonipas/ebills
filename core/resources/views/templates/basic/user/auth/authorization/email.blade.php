...
@endphp
 ...
 <div class="account-area">
    ...
    <div class="account-wrapper">
      ...
      <h4 class="text-center">@lang('Your Email'):  <strong>{{auth()->user()->email}}</h4>
        ...
        @endif
        <p class="text-center">@lang('Please check including your Junk/Spam Folder. if not found, you can') <a href="{{route('user.send_verify_code')}}?type=email" class="base--color">@lang('Resend code')...</a></p>
      </form>
