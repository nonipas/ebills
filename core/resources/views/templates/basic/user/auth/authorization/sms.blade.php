 ...
 <div class="account-area">
    ...
    <div class="account-wrapper">
      ...
      @csrf
        ...
        <h4 class="text-center">@lang('Enter Verification Code')</h4>
        <h4 class="text-center">@lang('Your Mobile'):  <strong>{{auth()->user()->mobile}}</h4>
        ...
        @endif
        <p class="text-center">@lang('Please check including your Junk/Spam Folder. if not found, you can') <a href="{{route('user.send_verify_code')}}?type=phone" class="base--color">@lang('Resend code')...</a></p>
      </form>
