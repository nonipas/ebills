                ...
                <div class="card-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                <label class="form-control-label font-weight-bold">@lang('Upline Referral Commission for sign up')</label>
                                <div class="input-group">
                                    <input type="number" value="{{ getAmount($general->upline_ref_sign_up) }}" name="upline_ref_sign_up" class="form-control form-control-lg"> 
