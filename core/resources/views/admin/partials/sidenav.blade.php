    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{menuActive('admin.service.category')}}">
                    <a href="{{route('admin.service.category')}}" class="nav-link ">
                        <i class="menu-icon las la-clipboard-list"></i>
                        <span class="menu-title">@lang('Service Category')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.applied*',3)}}">
                        <i class="menu-icon las la-file-import"></i>
                        <span class="menu-title">@lang('Applied Services')</span>
                        @if(0 < $pending_service_count)
                            <span class="menu-badge pill bg--primary ml-auto">
                                <i class="fa fa-exclamation"></i>
                            </span>
                        @endif
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.applied*',2)}} ">
                        <ul>

                            <li class="sidebar-menu-item {{menuActive('admin.applied.pending.service')}} ">
                                <a href="{{route('admin.applied.pending.service')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Pending Services')</span>
                                    @if($pending_service_count)
                                        <span class="menu-badge pill bg--primary ml-auto">{{ __($pending_service_count) }}</span>
                                    @endif
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.applied.approved')}} ">
                                <a href="{{route('admin.applied.approved')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Approved Services')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.applied.rejected')}} ">
                                <a href="{{route('admin.applied.rejected')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Rejected Services')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.applied.all')}} ">
                                <a href="{{route('admin.applied.all')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
