    ...
    <div class="row mb-none-30">
            ...
            <div class="card b-radius--10 overflow-hidden mt-30 box--shadow1">
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Downline')
                            <span class="font-weight-bold">{{ __($countDownline) }}</span>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="col-xl-9 col-lg-7 col-md-7 mb-30">
            ...
            <div class="row mb-none-30 justify-content-center">
                ...
                <div class="col-xl-4 col-lg-4 col-sm-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--17 b-radius--10 box-shadow has--link">
                        <a href="{{ route('admin.users.services', $user->id) }}" class="item--link"></a>
                        <div class="icon">
                            <i class="lab la-servicestack"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{ __($countService) }}</span>
                            </div>
                            <div class="desciption">
                                <span>@lang('Service Purchase')</span>
                            </div>
                        </div>
                    </div>
                </div><!-- dashboard-w1 end -->
            ...
            <div class="card mt-50">
                <div class="card-body">
                    <h5 class="card-title border-bottom pb-2">{{$user->fullname}} @lang('Information')</h5>
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <div class="input-group">
                                  ...
                                  <div class="input-group-append" style="cursor: pointer;" onclick="copyRefLink()">
