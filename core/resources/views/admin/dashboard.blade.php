            ...
            <div class="dashboard-w1 bg--gradi-44 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        ...
                        <span class="amount">{{ __($widget['count_approved_service']) }}</span>
                        <span class="currency-sign"></span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Approved Services')</span>
                    </div>

                    <a href="{{ route('admin.applied.approved') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--gradi-7 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="status"></span>
                        <span class="amount">{{ __($widget['count_pending_service']) }}</span>
                        <span class="currency-sign"></span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Pending Services')</span>
                    </div>

                    <a href="{{ route('admin.applied.pending.service') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--gradi-50 b-radius--10 box-shadow">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ __($widget['count_canceled_service']) }}</span>
                        <span class="currency-sign"></span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Rejected Services')</span>
                    </div>

                    <a href="{{ route('admin.applied.rejected') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--gradi-35 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ __($widget['count_total_applied_service']) }}</span>
                        <span class="currency-sign"></span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Applied Service')</span>
                    </div>

                    <a href="{{ route('admin.applied.all') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--gradi-49 b-radius--10 box-shadow">
                <div class="icon">
                   <i class="fab fa-servicestack"></i>
                </div>
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ __($widget['total_service']) }}</span>
                        <span class="currency-sign"></span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Available Services')</span>
                    </div>

                    <a href="{{ route('admin.service') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--gradi-39 b-radius--10 box-shadow">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ __($widget['count_ticket']) }}</span>
                        <span class="currency-sign"></span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Ticket')</span>
                    </div>
            ...
            <div class="dashboard-w1 bg--gradi-45 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        ...
                        <span class="currency-sign">@lang('Popular Service')</span>
                    </div>
                    <div class="desciption">
                        <span class="currency-sign">{{ __(@$widget['popular_service']->service->name) }}</span>
                    </div>

                    @if($widget['popular_service'])
                        <a href="{{ route('admin.service.update.page', @$widget['popular_service']->service->id) }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                    @else 
                        <a href="javascript:void(0)" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                    @endif
            ...
            <div class="dashboard-w1 bg--gradi-8 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="status"></span>
                        <span class="amount"></span>
                        <span class="currency-sign">@lang('Top Depositor')</span>
                    </div>
                    <div class="desciption">
                        <span class="currency-sign">{{ __(@$widget['top_depositor']->user->fullname) }}</span>
                    </div>

                    @if($widget['top_depositor'])
                        <a href="{{ route('admin.users.detail', $widget['top_depositor']->user->id) }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View Details')</a>
                    @else 
                      <a href="javascript:void(0)" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('N/A')</a>
                    @endif
